  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8">
      <div className={`mb-8 ${locale === 'ar' ? 'text-right' : 'text-left'}`}>
        <h2 className={`text-2xl md:text-3xl font-bold bg-gradient-to-r from-slate-600 via-blue-600 to-slate-600 bg-clip-text text-transparent mb-1.5 ${locale === 'ar' ? 'direction-rtl' : ''}`} dir={locale === 'ar' ? 'rtl' : 'ltr'}>
      ...
      <div className="mb-6 rounded-2xl border border-blue-200/60 bg-gradient-to-br from-blue-50 via-indigo-50/30 to-blue-50 p-6 shadow-lg backdrop-blur-sm" style={locale === 'ar' ? { direction: 'rtl' } : { direction: 'ltr' }}>
        <div className="mb-4 flex items-start gap-3 w-full">
          {locale === 'ar' ? (
            <>
              <div className="flex-1">
                <h3 className="mb-3 text-base font-bold text-blue-900">{t('dashboard.blockInfo')}</h3>
                <p className="mb-3 text-base font-bold leading-relaxed text-blue-800">
                  {t('dashboard.blockExplanation')}
                </p>
              </div>
              <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-md">
      ...
      {data.avgCompletedBlocks !== null && (
        <div className="mb-6 rounded-xl border-l-4 border-blue-500 bg-gradient-to-br from-blue-50 to-white p-6 shadow-md" style={locale === 'ar' ? { direction: 'rtl' } : { direction: 'ltr' }}>
          <div className={`mb-4 flex items-center ${locale === 'ar' ? 'flex-row-reverse' : ''} justify-between`}>
            {locale === 'ar' ? (
              <>
                <span className="rounded-full bg-gradient-to-r from-blue-600 to-blue-700 px-4 py-1.5 text-xs font-semibold text-white shadow-md">
                  {data.blocks.length} {data.blocks.length === 1 ? 'blok' : 'blokken'}
                </span>
                <h3 className="text-xl font-bold text-slate-900 text-right" dir="rtl">
          ...
          <p className={`text-6xl font-bold bg-gradient-to-r from-blue-600 to-slate-700 bg-clip-text text-transparent ${locale === 'ar' ? 'text-right' : 'text-left'}`}>
